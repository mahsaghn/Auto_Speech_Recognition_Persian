...
class AugmentationConfig:
    ...
    noise_dir: str = '/home/kngpu/mahsa/deepspeech.pytorch/data/noise'  # Directory to inject noise into audio. If default, noise Inject not added
...
class DataConfig:
    ...
    labels_path: str = 'labels_v4.json'  # Contains tokens for model output
...
@dataclass
class OptimConfig:
    learning_rate: float = 0.00025  # Initial Learning Rate
    learning_anneal: float = 0.985  # Annealing applied to learning rate after each epoch
...
class GCSCheckpointConfig(ModelCheckpointConf):
    gcs_bucket: str = 'models'  # Bucket to store model checkpoints e.g bucket-name
    gcs_save_folder: str = ''  # Folder to store model checkpoints in bucket e.g models/
...
class DeepSpeechTrainerConf(TrainerConf):
    ...
    #resume_from_checkpoint: str = '/home/kngpu/mahsa/deepspeech.pytorch/outputs/2022-01-19/11-04-43/models/epoch=14-step=6599.ckpt'
    resume_from_checkpoint: str = '/home/kngpu/mahsa/deepspeech.pytorch/outputs/2022-01-22/14-52-45/models/epoch=203-step=89759.ckpt'
    # python train.py +configs=mozilla trainer.resume_from_checkpoint=outputs/2022-01-19/11-04-43/models/epoch=14-step=6599.ckpt
...
#    transfer_checkpoint: str = '/home/kngpu/mahsa/deepspeech.pytorch/models/epoch87-step38719.ckpt'
    transfer_checkpoint: str = '/home/kngpu/mahsa/deepspeech.pytorch/models/librispeech_pretrained_v3.ckpt'
